...
public class DoctorForm extends JFrame implements ActionListener {
     ...
     * @param db
     */
    public DoctorForm(DatabaseClass db) {
        ...
        JLabel idLabel = new JLabel("의사 번호:");
    ...
    /**
     * 액션 리스너
     *  - 의사 추가 버튼 클릭시 실행되는 메소드로 데이터베이스 클래스에 환자를 추가시킨다.
     *    즉, 의사 ArrayList에 의사 한명 추가함.
     */
	public void actionPerformed(ActionEvent e) {
        ...
        // 화면에서 입력받은 데이터로 의사 객체 생성
        Doctor doctor = new Doctor(id, jumin, name, address, code, medicalDep, hiredate);
       
        // 생성한 의사 객체를 ArrayList<Doctor> doctorList에 저장
        this.db.addDoctor(doctor);
       
		// 의사 객체 성공적으로 등록 완료 메시지
		JOptionPane.showMessageDialog(this, "등록완료");
		
		// 현재까지 등록된 의사수 확인
        System.out.println("의사 객체 등록 완료 의사수 : " + db.getDoctorCount());
    ...
    public static void main(String[] args) {
    	new DoctorForm(new DatabaseClass());
    }
